...
<?php
/**
 * Email patient appointment inforamtion and files
 *
 * @author    Julie Buurman <openemr@medicode.nl>
...
function messageCreate($datum, $tijd, $afspraktype)
{

    $message = xlt("Afspraak Bevestiging voor BeterKliniek") .":<br />";
        $message .= "<br />";
    $sub = '';
    $message .= xlt("Datum") . ": " . text($datum) . "<br /><br /><strong>" .
        xlt("Tijd") . ":</strong> " . text($tijd) . "<br /><strong>" .
        xlt("Afspraak") . ":</strong> " .
        text($afspraktype) . "<br /><br />" . $sub;
    return $message;
}
