...
<head>
    ...
    <script type="text/javascript"
            src="../interface/main/tabs/js/dialog_utils.js?v=<?php echo $v_js_includes; ?>"></script>
    <link href="<?php echo $GLOBALS['web_root']; ?>/portal/assets/css/style.css?v=<?php echo $v_js_includes; ?>"
    ...
    <script
        src="<?php echo $GLOBALS['web_root']; ?>/portal/sign/assets/signature_pad.umd.js?v=<?php echo $v_js_includes; ?>"
...
<header class="header">
    <a href="home.php" class="logo hidden-xs"><img
            src='<?php echo $GLOBALS['images_static_relative']; ?>/logo-full-con.png'/></a>
        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                <li class="dropdown messages-menu"><a href="#"
                            ...
                            class="label label-success"> <?php echo text($newcnt); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a
                                href="<?php echo $GLOBALS['web_root']; ?>/portal/messaging/messages.php"><?php echo xlt('See All Messages'); ?></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown user user-menu"><a href="#"
                    ...
                    <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                        ...
                        <li><a href="<?php echo $GLOBALS['web_root']; ?>/portal/messaging/messages.php"> <i
                                ...
                                <span
                                    class="badge badge-danger pull-right"> <?php echo text($msgcnt); ?></span> <?php echo xlt('Messages'); ?>
                            </a></li>
                        <li class="divider"></li>
                        <li>
                            <?php if ($GLOBALS['allow_portal_chat']) { ?>
                                <a href="<?php echo $GLOBALS['web_root']; ?>/portal/messaging/secure_chat.php?fullscreen=true">
                                    <i class="fa fa-user fa-fw pull-right"></i><?php echo xlt('Chat'); ?></a>
                            <?php } ?>
                            <a href="javascript:changeCredentials(event)"> <i
                                    class="fa fa-cog fa-fw pull-right"></i> <?php echo xlt('Change Credentials'); ?></a>
                        </li>
        ...
        <section class="sidebar">
            ...
            <ul class="nav nav-pills nav-stacked" style='font-color:#fff;'><!-- css class was sidebar-menu -->
                <li data-toggle="pill"><a href="#profilepanel" data-toggle="collapse"
                                          data-parent="#panelgroup"> <i class="fa fa-calendar-o"></i>
                        <span><?php echo xlt('Profile'); ?></span>
                    </a></li>
                <li data-toggle="pill"><a href="#lists" data-toggle="collapse"
                                          data-parent="#panelgroup"> <i class="fa fa-list"></i>
                        <span><?php echo xlt('Lists'); ?></span>
                    </a></li>
                <li>
                    <a href="<?php echo $GLOBALS['web_root']; ?>/portal/patient/onsitedocuments?pid=<?php echo attr_url($pid); ?>">
                        <i class="fa fa-gavel"></i>
                        <span><?php echo xlt('Patient Documenten'); ?></span>
                    </a></li>
                <?php if ($GLOBALS['portal_onsite_document_upload']) { ?>
                    <li data-toggle="pill"><a href="#uploadpanel" data-toggle="collapse"
                                              data-parent="#panelgroup"> <i class="fa fa-upload"></i>
                            <span><?php echo xlt('Upload Documenten'); ?></span></a></li>
                <?php } ?>
                <?php if ($GLOBALS['allow_portal_appointments']) { ?>
                    <li data-toggle="pill"><a href="#appointmentpanel" data-toggle="collapse"
                                              data-parent="#panelgroup"> <i class="fa fa-calendar-o"></i>
                            <span><?php echo xlt("Appointment"); ?></span>
                        </a></li>
                <?php } ?>
                <?php if ($GLOBALS['portal_two_ledger'] || $GLOBALS['portal_two_payments']) { ?>
                    <li class="dropdown accounting-menu"><a href="#"
                                                            class="dropdown-toggle" data-toggle="dropdown"> <i
                                class="fa fa-book"></i> <span><?php echo xlt('Accountings'); ?></span></a>
                        <ul class="dropdown-menu">
                            <?php if ($GLOBALS['portal_two_ledger']) { ?>
                                <li data-toggle="pill"><a href="#ledgerpanel" data-toggle="collapse"
                                                          data-parent="#panelgroup"> <i class="fa fa-folder-open"></i>
                                        <span><?php echo xlt('Ledger'); ?></span>
                                    </a></li>
                            <?php } ?>
                            <?php if ($GLOBALS['portal_two_payments']) { ?>
                                <li data-toggle="pill"><a href="#paymentpanel" data-toggle="collapse"
                                                          data-parent="#panelgroup"> <i class="fa fa-credit-card"></i>
                                        <span><?php echo xlt('Make Payment'); ?></span>
                                    </a></li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                <li class="dropdown reporting-menu"><a href="#"
                                                       class="dropdown-toggle" data-toggle="dropdown"> <i
                            class="fa fa-calendar"></i> <span><?php echo xlt('Reports'); ?></span></a>
                    <ul class="dropdown-menu">
                        <?php if ($GLOBALS['ccda_alt_service_enable'] > 1) { ?>
                            <li><a id="callccda"
                                   href="<?php echo $GLOBALS['web_root']; ?>/ccdaservice/ccda_gateway.php?action=startandrun">
                                    <i class="fa fa-envelope"
                                       aria-hidden="true"></i><span><?php echo xlt('View CCD'); ?></span></a></li>
                        <?php } ?>
                        <?php if (!empty($GLOBALS['portal_onsite_document_download'])) { ?>
                            <li data-toggle="pill"><a href="#reportpanel" data-toggle="collapse"
                                                      data-parent="#panelgroup"> <i class="fa fa-folder-open"></i>
                                    <span><?php echo xlt('Report Content'); ?></span></a></li>
                ...
                <?php if ($GLOBALS['allow_portal_chat']) { ?>
                    <li data-toggle="pill"><a href="#messagespanel" data-toggle="collapse"
                            ...
                            <span><?php echo xlt("Secure Chat"); ?></span>
                        </a></li>
                <?php } ?>
                ...
                <li><a href="logout.php"><i class="fa fa-ban fa-fw"></i> <span><?php echo xlt('Logout'); ?></span></a>
                </li>
            </ul>
        </section>
        <!-- /.sidebar -->
